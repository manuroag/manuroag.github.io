...
title: about
permalink: /
subtitle: M.Sc. Student. <a href='https://cinvestav.mx/'>Cinvestav</a>, Physics Department. 
...
**My Master's thesis** focused on enhancing the [KCD method](https://kcd.cinvestav.mx/)'s predictive capabilities for protein Circular Dichroism (CD) spectra. **By designing and training novel deep Bayesian Neural Networks (BNNs)**, I **achieved a 40% improvement** in prediction accuracy compared to the original model. This work not only strengthened my expertise in **PyTorch**, **data-driven modeling**, and **scientific computing** but also reinforced my ability to **translate theoretical concepts into practical tools**, a skill I aim to further develop in my PhD.
